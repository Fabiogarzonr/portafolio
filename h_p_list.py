...
h_p_data_list = [
    ...
    ("H360", "California Proposition 65 Warning: This product contains a component (or components) that may cause birth defects or other reproductive harm in a quantity greater than or equal to 0.1%"),
